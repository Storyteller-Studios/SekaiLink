...
{
    public TransportEndpoint(TransportKind kind, string address, string? serviceId = null,
        string? writeCharacteristicId = null, string? notifyCharacteristicId = null)
    {
        Kind = kind;
...
{
    public TransportStateChangedEventArgs(TransportState state, Exception? error = null)
    {
        State = state;
        Error = error;
    }
...
{
    IProtocolTransport Create(TransportEndpoint endpoint);
}